    ...
    <div class="container p-5">
        <div class="row d-flex justify-content-center align-items-center mb-3" data-aos="fade-right">
            <div class="image-galery mb-3">
                <img src="{{ asset('assets/img/anh-nguyen-kcA-c3f_3FE-unsplash.jpg')}}"
            ...
            <div class="image-galery mb-3">
                <img src="{{ asset('assets/img/brooke-lark-1Rm9GLHV0UA-unsplash.jpg')}}"
                class="w-100 h-100 object-fit-cover"
                alt="">
            </div>
            <div class="image-galery mb-3">
                <img src="{{ asset('assets/img/brooke-lark-nBtmglfY0HU-unsplash.jpg')}}"
                class="w-100 h-100 object-fit-cover"
                alt="">
            </div>
        </div>
