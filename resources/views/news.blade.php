            ...
            <div class="d-lg-flex gap-3" data-aos="fade-up-left">
                ...
                <div class="card news-card mb-3" style="width: 18rem;">
                    ...
                    <div class="card-body p-4">
                        <h6 class="card-title fw-bold text-uppercase">{{ $post->title }}</h6>
                        <small class="card-text">{{ strip_tags(Str::limit($post->content, 200)) }}</small>
                        <div class="d-flex justify-content-between align-items-center mt-3">
                            <small><a href="{{ route('viewberita', $post->id) }}" class="link-warning text-decoration-none">Baca selengkapnya</a>
                                </small>
